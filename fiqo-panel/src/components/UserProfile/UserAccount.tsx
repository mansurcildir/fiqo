    ...
    <>
      <div className="mt-6 flex flex-col gap-6 rounded-2xl border border-gray-200 p-5 lg:items-start lg:justify-between lg:p-6 dark:border-gray-800">
        ...
        <div className="flex w-full flex-col gap-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
          <div className="flex w-full flex-col gap-6 sm:flex-row lg:items-start lg:justify-between">
            <h4 className="flex items-center gap-2 text-lg font-semibold text-gray-800 dark:text-white/90">
              Google
            ...
            <button
              ...
              className="shadow-theme-xs inline-flex w-auto items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
