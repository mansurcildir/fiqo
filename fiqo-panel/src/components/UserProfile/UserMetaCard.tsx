...
export default function UserMetaCard({ userInfo, avatarSrc, fetchProfile }: Props) {
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
            <div
              ...
              className="h-20 w-20 cursor-pointer overflow-hidden rounded-full border border-gray-200 dark:border-gray-800"
            >
      ...
      <Modal isOpen={avatarModal.isOpen} onClose={avatarModal.closeModal} className="m-4 max-w-[700px]">
        <DropzoneComponent />
      </Modal>
    </>
  );
